...
#ifndef WECHATCLIENT_COMMAND_DEF_H
#define WECHATCLIENT_COMMAND_DEF_H
...
const COMMAND_DEF REFILE_ACK = FILE_GET_ACK+1;
const COMMAND_DEF TESTFILE = REFILE_ACK + 1;

#endif //WECHATCLIENT_COMMAND_DEF_H
